...
class CartController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($duplicata->isNotEmpty()) {
            return redirect()->route('products.index')->with('success', 'Product has already added!');
        }
        ...
        return redirect()->route('products.index')->with('success', 'Product has been added to your cart');
    }
